...
vuint8mf8_t test_vabd_vv_u8mf8_m(vbool64_t vm, vint8mf8_t vs2, vint8mf8_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8mf8_m(vm, vs2, vs1, vl);
}

vuint8mf8_t test_vabd_vx_u8mf8_m(vbool64_t vm, vint8mf8_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8mf8_m(vm, vs2, rs1, vl);
}

vuint8mf4_t test_vabd_vv_u8mf4_m(vbool32_t vm, vint8mf4_t vs2, vint8mf4_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8mf4_m(vm, vs2, vs1, vl);
}

vuint8mf4_t test_vabd_vx_u8mf4_m(vbool32_t vm, vint8mf4_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8mf4_m(vm, vs2, rs1, vl);
}

vuint8mf2_t test_vabd_vv_u8mf2_m(vbool16_t vm, vint8mf2_t vs2, vint8mf2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8mf2_m(vm, vs2, vs1, vl);
}

vuint8mf2_t test_vabd_vx_u8mf2_m(vbool16_t vm, vint8mf2_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8mf2_m(vm, vs2, rs1, vl);
}

vuint8m1_t test_vabd_vv_u8m1_m(vbool8_t vm, vint8m1_t vs2, vint8m1_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8m1_m(vm, vs2, vs1, vl);
}

vuint8m1_t test_vabd_vx_u8m1_m(vbool8_t vm, vint8m1_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8m1_m(vm, vs2, rs1, vl);
}

vuint8m2_t test_vabd_vv_u8m2_m(vbool4_t vm, vint8m2_t vs2, vint8m2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8m2_m(vm, vs2, vs1, vl);
}

vuint8m2_t test_vabd_vx_u8m2_m(vbool4_t vm, vint8m2_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8m2_m(vm, vs2, rs1, vl);
}

vuint8m4_t test_vabd_vv_u8m4_m(vbool2_t vm, vint8m4_t vs2, vint8m4_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8m4_m(vm, vs2, vs1, vl);
}

vuint8m4_t test_vabd_vx_u8m4_m(vbool2_t vm, vint8m4_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8m4_m(vm, vs2, rs1, vl);
}

vuint8m8_t test_vabd_vv_u8m8_m(vbool1_t vm, vint8m8_t vs2, vint8m8_t vs1, size_t vl) {
  return __riscv_vabd_vv_u8m8_m(vm, vs2, vs1, vl);
}

vuint8m8_t test_vabd_vx_u8m8_m(vbool1_t vm, vint8m8_t vs2, int8_t rs1, size_t vl) {
  return __riscv_vabd_vx_u8m8_m(vm, vs2, rs1, vl);
}

vuint16mf4_t test_vabd_vv_u16mf4_m(vbool64_t vm, vint16mf4_t vs2, vint16mf4_t vs1, size_t vl) {
  return __riscv_vabd_vv_u16mf4_m(vm, vs2, vs1, vl);
}

vuint16mf4_t test_vabd_vx_u16mf4_m(vbool64_t vm, vint16mf4_t vs2, int16_t rs1, size_t vl) {
  return __riscv_vabd_vx_u16mf4_m(vm, vs2, rs1, vl);
}

vuint16mf2_t test_vabd_vv_u16mf2_m(vbool32_t vm, vint16mf2_t vs2, vint16mf2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u16mf2_m(vm, vs2, vs1, vl);
}

vuint16mf2_t test_vabd_vx_u16mf2_m(vbool32_t vm, vint16mf2_t vs2, int16_t rs1, size_t vl) {
  return __riscv_vabd_vx_u16mf2_m(vm, vs2, rs1, vl);
}

vuint16m1_t test_vabd_vv_u16m1_m(vbool16_t vm, vint16m1_t vs2, vint16m1_t vs1, size_t vl) {
  return __riscv_vabd_vv_u16m1_m(vm, vs2, vs1, vl);
}

vuint16m1_t test_vabd_vx_u16m1_m(vbool16_t vm, vint16m1_t vs2, int16_t rs1, size_t vl) {
  return __riscv_vabd_vx_u16m1_m(vm, vs2, rs1, vl);
}

vuint16m2_t test_vabd_vv_u16m2_m(vbool8_t vm, vint16m2_t vs2, vint16m2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u16m2_m(vm, vs2, vs1, vl);
}

vuint16m2_t test_vabd_vx_u16m2_m(vbool8_t vm, vint16m2_t vs2, int16_t rs1, size_t vl) {
  return __riscv_vabd_vx_u16m2_m(vm, vs2, rs1, vl);
}

vuint16m4_t test_vabd_vv_u16m4_m(vbool4_t vm, vint16m4_t vs2, vint16m4_t vs1, size_t vl) {
  return __riscv_vabd_vv_u16m4_m(vm, vs2, vs1, vl);
}

vuint16m4_t test_vabd_vx_u16m4_m(vbool4_t vm, vint16m4_t vs2, int16_t rs1, size_t vl) {
  return __riscv_vabd_vx_u16m4_m(vm, vs2, rs1, vl);
}

vuint16m8_t test_vabd_vv_u16m8_m(vbool2_t vm, vint16m8_t vs2, vint16m8_t vs1, size_t vl) {
  return __riscv_vabd_vv_u16m8_m(vm, vs2, vs1, vl);
}

vuint16m8_t test_vabd_vx_u16m8_m(vbool2_t vm, vint16m8_t vs2, int16_t rs1, size_t vl) {
  return __riscv_vabd_vx_u16m8_m(vm, vs2, rs1, vl);
}

vuint32mf2_t test_vabd_vv_u32mf2_m(vbool64_t vm, vint32mf2_t vs2, vint32mf2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u32mf2_m(vm, vs2, vs1, vl);
}

vuint32mf2_t test_vabd_vx_u32mf2_m(vbool64_t vm, vint32mf2_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vabd_vx_u32mf2_m(vm, vs2, rs1, vl);
}

vuint32m1_t test_vabd_vv_u32m1_m(vbool32_t vm, vint32m1_t vs2, vint32m1_t vs1, size_t vl) {
  return __riscv_vabd_vv_u32m1_m(vm, vs2, vs1, vl);
}

vuint32m1_t test_vabd_vx_u32m1_m(vbool32_t vm, vint32m1_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vabd_vx_u32m1_m(vm, vs2, rs1, vl);
}

vuint32m2_t test_vabd_vv_u32m2_m(vbool16_t vm, vint32m2_t vs2, vint32m2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u32m2_m(vm, vs2, vs1, vl);
}

vuint32m2_t test_vabd_vx_u32m2_m(vbool16_t vm, vint32m2_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vabd_vx_u32m2_m(vm, vs2, rs1, vl);
}

vuint32m4_t test_vabd_vv_u32m4_m(vbool8_t vm, vint32m4_t vs2, vint32m4_t vs1, size_t vl) {
  return __riscv_vabd_vv_u32m4_m(vm, vs2, vs1, vl);
}

vuint32m4_t test_vabd_vx_u32m4_m(vbool8_t vm, vint32m4_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vabd_vx_u32m4_m(vm, vs2, rs1, vl);
}

vuint32m8_t test_vabd_vv_u32m8_m(vbool4_t vm, vint32m8_t vs2, vint32m8_t vs1, size_t vl) {
  return __riscv_vabd_vv_u32m8_m(vm, vs2, vs1, vl);
}

vuint32m8_t test_vabd_vx_u32m8_m(vbool4_t vm, vint32m8_t vs2, int32_t rs1, size_t vl) {
  return __riscv_vabd_vx_u32m8_m(vm, vs2, rs1, vl);
}

vuint64m1_t test_vabd_vv_u64m1_m(vbool64_t vm, vint64m1_t vs2, vint64m1_t vs1, size_t vl) {
  return __riscv_vabd_vv_u64m1_m(vm, vs2, vs1, vl);
}

vuint64m1_t test_vabd_vx_u64m1_m(vbool64_t vm, vint64m1_t vs2, int64_t rs1, size_t vl) {
  return __riscv_vabd_vx_u64m1_m(vm, vs2, rs1, vl);
}

vuint64m2_t test_vabd_vv_u64m2_m(vbool32_t vm, vint64m2_t vs2, vint64m2_t vs1, size_t vl) {
  return __riscv_vabd_vv_u64m2_m(vm, vs2, vs1, vl);
}

vuint64m2_t test_vabd_vx_u64m2_m(vbool32_t vm, vint64m2_t vs2, int64_t rs1, size_t vl) {
  return __riscv_vabd_vx_u64m2_m(vm, vs2, rs1, vl);
}

vuint64m4_t test_vabd_vv_u64m4_m(vbool16_t vm, vint64m4_t vs2, vint64m4_t vs1, size_t vl) {
  return __riscv_vabd_vv_u64m4_m(vm, vs2, vs1, vl);
}

vuint64m4_t test_vabd_vx_u64m4_m(vbool16_t vm, vint64m4_t vs2, int64_t rs1, size_t vl) {
  return __riscv_vabd_vx_u64m4_m(vm, vs2, rs1, vl);
}

vuint64m8_t test_vabd_vv_u64m8_m(vbool8_t vm, vint64m8_t vs2, vint64m8_t vs1, size_t vl) {
  return __riscv_vabd_vv_u64m8_m(vm, vs2, vs1, vl);
}

vuint64m8_t test_vabd_vx_u64m8_m(vbool8_t vm, vint64m8_t vs2, int64_t rs1, size_t vl) {
  return __riscv_vabd_vx_u64m8_m(vm, vs2, rs1, vl);
}
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vabd\.[ivxfswum.]+\s+} 88 } } */
