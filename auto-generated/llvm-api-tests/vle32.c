...
vfloat32mf2_t test_vle32_v_f32mf2(const float *rs1, size_t vl) {
  return __riscv_vle32_v_f32mf2(rs1, vl);
}

vfloat32m1_t test_vle32_v_f32m1(const float *rs1, size_t vl) {
  return __riscv_vle32_v_f32m1(rs1, vl);
}

vfloat32m2_t test_vle32_v_f32m2(const float *rs1, size_t vl) {
  return __riscv_vle32_v_f32m2(rs1, vl);
}

vfloat32m4_t test_vle32_v_f32m4(const float *rs1, size_t vl) {
  return __riscv_vle32_v_f32m4(rs1, vl);
}

vfloat32m8_t test_vle32_v_f32m8(const float *rs1, size_t vl) {
...
vuint32mf2_t test_vle32_v_u32mf2_m(vbool64_t vm, const uint32_t *rs1,
                                   size_t vl) {
