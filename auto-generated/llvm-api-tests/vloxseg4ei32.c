...
vfloat16mf4x4_t test_vloxseg4ei32_v_f16mf4x4(const _Float16 *rs1,
                                             vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f16mf4x4(rs1, rs2, vl);
}

vfloat16mf2x4_t test_vloxseg4ei32_v_f16mf2x4(const _Float16 *rs1,
                                             vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f16mf2x4(rs1, rs2, vl);
}

vfloat16m1x4_t test_vloxseg4ei32_v_f16m1x4(const _Float16 *rs1, vuint32m2_t rs2,
                                           size_t vl) {
  return __riscv_vloxseg4ei32_v_f16m1x4(rs1, rs2, vl);
}

vfloat16m2x4_t test_vloxseg4ei32_v_f16m2x4(const _Float16 *rs1, vuint32m4_t rs2,
                                           size_t vl) {
  return __riscv_vloxseg4ei32_v_f16m2x4(rs1, rs2, vl);
}

vfloat32mf2x4_t test_vloxseg4ei32_v_f32mf2x4(const float *rs1, vuint32mf2_t rs2,
                                             size_t vl) {
  return __riscv_vloxseg4ei32_v_f32mf2x4(rs1, rs2, vl);
}

vfloat32m1x4_t test_vloxseg4ei32_v_f32m1x4(const float *rs1, vuint32m1_t rs2,
                                           size_t vl) {
  return __riscv_vloxseg4ei32_v_f32m1x4(rs1, rs2, vl);
}

vfloat32m2x4_t test_vloxseg4ei32_v_f32m2x4(const float *rs1, vuint32m2_t rs2,
                                           size_t vl) {
  return __riscv_vloxseg4ei32_v_f32m2x4(rs1, rs2, vl);
}

vfloat64m1x4_t test_vloxseg4ei32_v_f64m1x4(const double *rs1, vuint32mf2_t rs2,
                                           size_t vl) {
  return __riscv_vloxseg4ei32_v_f64m1x4(rs1, rs2, vl);
}

vfloat64m2x4_t test_vloxseg4ei32_v_f64m2x4(const double *rs1, vuint32m1_t rs2,
                                           size_t vl) {
...
vfloat16m1x4_t test_vloxseg4ei32_v_f16m1x4_m(vbool16_t vm, const _Float16 *rs1,
                                             vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f16m1x4_m(vm, rs1, rs2, vl);
}

vfloat16m2x4_t test_vloxseg4ei32_v_f16m2x4_m(vbool8_t vm, const _Float16 *rs1,
                                             vuint32m4_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f16m2x4_m(vm, rs1, rs2, vl);
}

vfloat32mf2x4_t test_vloxseg4ei32_v_f32mf2x4_m(vbool64_t vm, const float *rs1,
                                               vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f32mf2x4_m(vm, rs1, rs2, vl);
}

vfloat32m1x4_t test_vloxseg4ei32_v_f32m1x4_m(vbool32_t vm, const float *rs1,
                                             vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f32m1x4_m(vm, rs1, rs2, vl);
}

vfloat32m2x4_t test_vloxseg4ei32_v_f32m2x4_m(vbool16_t vm, const float *rs1,
                                             vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f32m2x4_m(vm, rs1, rs2, vl);
}

vfloat64m1x4_t test_vloxseg4ei32_v_f64m1x4_m(vbool64_t vm, const double *rs1,
                                             vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei32_v_f64m1x4_m(vm, rs1, rs2, vl);
}

vfloat64m2x4_t test_vloxseg4ei32_v_f64m2x4_m(vbool32_t vm, const double *rs1,
                                             vuint32m1_t rs2, size_t vl) {
