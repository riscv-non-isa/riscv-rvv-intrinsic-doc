...
vfloat16mf4x5_t test_vlseg5e16_v_f16mf4x5(const _Float16 *rs1, size_t vl) {
  return __riscv_vlseg5e16_v_f16mf4x5(rs1, vl);
}

vfloat16mf2x5_t test_vlseg5e16_v_f16mf2x5(const _Float16 *rs1, size_t vl) {
  return __riscv_vlseg5e16_v_f16mf2x5(rs1, vl);
}

vfloat16m1x5_t test_vlseg5e16_v_f16m1x5(const _Float16 *rs1, size_t vl) {
