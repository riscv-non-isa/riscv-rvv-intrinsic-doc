...
vfloat16mf4x7_t test_vlsseg7e16_v_f16mf4x7(const _Float16 *rs1, ptrdiff_t rs2,
                                           size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf4x7(rs1, rs2, vl);
}

vfloat16mf2x7_t test_vlsseg7e16_v_f16mf2x7(const _Float16 *rs1, ptrdiff_t rs2,
                                           size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf2x7(rs1, rs2, vl);
}

vfloat16m1x7_t test_vlsseg7e16_v_f16m1x7(const _Float16 *rs1, ptrdiff_t rs2,
                                         size_t vl) {
  return __riscv_vlsseg7e16_v_f16m1x7(rs1, rs2, vl);
}
...
vfloat16mf4x7_t test_vlsseg7e16_v_f16mf4x7_m(vbool64_t vm, const _Float16 *rs1,
  ...
  return __riscv_vlsseg7e16_v_f16mf4x7_m(vm, rs1, rs2, vl);
}

vfloat16mf2x7_t test_vlsseg7e16_v_f16mf2x7_m(vbool32_t vm, const _Float16 *rs1,
                                             ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf2x7_m(vm, rs1, rs2, vl);
}

vfloat16m1x7_t test_vlsseg7e16_v_f16m1x7_m(vbool16_t vm, const _Float16 *rs1,
                                           ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e16_v_f16m1x7_m(vm, rs1, rs2, vl);
}
