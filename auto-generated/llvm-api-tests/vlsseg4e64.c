...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4(const double *rs1, ptrdiff_t rs2,
                                         size_t vl) {
  return __riscv_vlsseg4e64_v_f64m1x4(rs1, rs2, vl);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4(const double *rs1, ptrdiff_t rs2,
                                         size_t vl) {
  return __riscv_vlsseg4e64_v_f64m2x4(rs1, rs2, vl);
}

vint64m1x4_t test_vlsseg4e64_v_i64m1x4(const int64_t *rs1, ptrdiff_t rs2,
                                       size_t vl) {
  return __riscv_vlsseg4e64_v_i64m1x4(rs1, rs2, vl);
}

vint64m2x4_t test_vlsseg4e64_v_i64m2x4(const int64_t *rs1, ptrdiff_t rs2,
                                       size_t vl) {
  return __riscv_vlsseg4e64_v_i64m2x4(rs1, rs2, vl);
}

vuint64m1x4_t test_vlsseg4e64_v_u64m1x4(const uint64_t *rs1, ptrdiff_t rs2,
                                        size_t vl) {
  return __riscv_vlsseg4e64_v_u64m1x4(rs1, rs2, vl);
}

vuint64m2x4_t test_vlsseg4e64_v_u64m2x4(const uint64_t *rs1, ptrdiff_t rs2,
                                        size_t vl) {
