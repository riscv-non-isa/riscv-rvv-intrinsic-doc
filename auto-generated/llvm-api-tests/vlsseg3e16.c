...
vfloat16mf4x3_t test_vlsseg3e16_v_f16mf4x3(const _Float16 *rs1, ptrdiff_t rs2,
                                           size_t vl) {
  return __riscv_vlsseg3e16_v_f16mf4x3(rs1, rs2, vl);
}

vfloat16mf2x3_t test_vlsseg3e16_v_f16mf2x3(const _Float16 *rs1, ptrdiff_t rs2,
                                           size_t vl) {
  return __riscv_vlsseg3e16_v_f16mf2x3(rs1, rs2, vl);
}

vfloat16m1x3_t test_vlsseg3e16_v_f16m1x3(const _Float16 *rs1, ptrdiff_t rs2,
                                         size_t vl) {
  return __riscv_vlsseg3e16_v_f16m1x3(rs1, rs2, vl);
}

vfloat16m2x3_t test_vlsseg3e16_v_f16m2x3(const _Float16 *rs1, ptrdiff_t rs2,
                                         size_t vl) {
  return __riscv_vlsseg3e16_v_f16m2x3(rs1, rs2, vl);
}
