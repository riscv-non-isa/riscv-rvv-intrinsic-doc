...
#define vdot4a_tu(...) __riscv_vdot4a_tu(__VA_ARGS__)
#define vdot4asu_tu(...) __riscv_vdot4asu_tu(__VA_ARGS__)
#define vdot4aus_tu(...) __riscv_vdot4aus_tu(__VA_ARGS__)
#define vdot4au_tu(...) __riscv_vdot4au_tu(__VA_ARGS__)
#define vdot4a_ta(...) __riscv_vdot4a(__VA_ARGS__)
#define vdot4asu_ta(...) __riscv_vdot4asu(__VA_ARGS__)
#define vdot4aus_ta(...) __riscv_vdot4aus(__VA_ARGS__)
#define vdot4au_ta(...) __riscv_vdot4au(__VA_ARGS__)
// masked functions
#define vdot4a_tuma(...) __riscv_vdot4a_tum(__VA_ARGS__)
#define vdot4asu_tuma(...) __riscv_vdot4asu_tum(__VA_ARGS__)
#define vdot4aus_tuma(...) __riscv_vdot4aus_tum(__VA_ARGS__)
#define vdot4au_tuma(...) __riscv_vdot4au_tum(__VA_ARGS__)
// masked functions
#define vdot4a_tumu(...) __riscv_vdot4a_tumu(__VA_ARGS__)
#define vdot4asu_tumu(...) __riscv_vdot4asu_tumu(__VA_ARGS__)
#define vdot4aus_tumu(...) __riscv_vdot4aus_tumu(__VA_ARGS__)
#define vdot4au_tumu(...) __riscv_vdot4au_tumu(__VA_ARGS__)
// masked functions
#define vdot4a_tama(...) __riscv_vdot4a(__VA_ARGS__)
#define vdot4asu_tama(...) __riscv_vdot4asu(__VA_ARGS__)
#define vdot4aus_tama(...) __riscv_vdot4aus(__VA_ARGS__)
#define vdot4au_tama(...) __riscv_vdot4au(__VA_ARGS__)
// masked functions
#define vdot4a_tamu(...) __riscv_vdot4a_mu(__VA_ARGS__)
#define vdot4asu_tamu(...) __riscv_vdot4asu_mu(__VA_ARGS__)
#define vdot4aus_tamu(...) __riscv_vdot4aus_mu(__VA_ARGS__)
#define vdot4au_tamu(...) __riscv_vdot4au_mu(__VA_ARGS__)
