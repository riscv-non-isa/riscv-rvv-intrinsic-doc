...
vfloat32m1_t test_vfqwbdota_vv_f8e4m3m1_f32m1_rm(vfloat32m1_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m1_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfqwbdota_vv_f8e4m3m1_f32m2_rm(vfloat32m2_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m2_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfqwbdota_vv_f8e4m3m1_f32m4_rm(vfloat32m4_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m4_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfqwbdota_vv_f8e4m3m1_f32m8_rm(vfloat32m8_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m8_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m1_t test_vfqwbdota_vv_f8e5m2m1_f32m1_rm(vfloat32m1_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m1_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfqwbdota_vv_f8e5m2m1_f32m2_rm(vfloat32m2_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m2_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfqwbdota_vv_f8e5m2m1_f32m4_rm(vfloat32m4_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m4_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfqwbdota_vv_f8e5m2m1_f32m8_rm(vfloat32m8_t vd,
                                                 vuint8m8_t vs2, vuint8m1_t vs1,
                                                 size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m8_rm(vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}

vfloat32m1_t test_vfqwbdota_vv_f8e4m3m1_f32m1_rm_m(vbool32_t vm,
                                                   vfloat32m1_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m1_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfqwbdota_vv_f8e4m3m1_f32m2_rm_m(vbool16_t vm,
                                                   vfloat32m2_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m2_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfqwbdota_vv_f8e4m3m1_f32m4_rm_m(vbool8_t vm, vfloat32m4_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m4_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfqwbdota_vv_f8e4m3m1_f32m8_rm_m(vbool4_t vm, vfloat32m8_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e4m3m1_f32m8_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m1_t test_vfqwbdota_vv_f8e5m2m1_f32m1_rm_m(vbool32_t vm,
                                                   vfloat32m1_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m1_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfqwbdota_vv_f8e5m2m1_f32m2_rm_m(vbool16_t vm,
                                                   vfloat32m2_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m2_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfqwbdota_vv_f8e5m2m1_f32m4_rm_m(vbool8_t vm, vfloat32m4_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m4_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfqwbdota_vv_f8e5m2m1_f32m8_rm_m(vbool4_t vm, vfloat32m8_t vd,
                                                   vuint8m8_t vs2,
                                                   vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_vv_f8e5m2m1_f32m8_rm_m(vm, vd, vs2, vs1, 0,
                                                  __RISCV_FRM_RNE, vl);
}
