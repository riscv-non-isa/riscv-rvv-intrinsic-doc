...
vfloat32m1_t test_vfqwbdota_vv_f8e4m3m1_f32m1_rm_tum(
  ...
  return __riscv_vfqwbdota_f8e4m3_f32_tum(vm, vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                          vl);
}
...
vfloat32m1_t test_vfqwbdota_vv_f8e5m2m1_f32m1_rm_tum(
    vbool32_t vm, vfloat32m1_t vd, vuint8m8_t vs2, vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_f8e5m2_f32_tum(vm, vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                          vl);
}
...
vfloat32m1_t test_vfqwbdota_vv_f8e4m3m1_f32m1_rm_tumu(
    vbool32_t vm, vfloat32m1_t vd, vuint8m8_t vs2, vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_f8e4m3_f32_tumu(vm, vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                           vl);
}
...
vfloat32m1_t test_vfqwbdota_vv_f8e5m2m1_f32m1_rm_tumu(
    vbool32_t vm, vfloat32m1_t vd, vuint8m8_t vs2, vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_f8e5m2_f32_tumu(vm, vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                           vl);
}
...
vfloat32m1_t test_vfqwbdota_vv_f8e4m3m1_f32m1_rm_mu(vbool32_t vm,
                                                    ...
                                                    vuint8m8_t vs2,
                                                    vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_f8e4m3_f32_mu(vm, vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                         vl);
}
...
vfloat32m1_t test_vfqwbdota_vv_f8e5m2m1_f32m1_rm_mu(vbool32_t vm,
                                                    ...
                                                    vuint8m8_t vs2,
                                                    vuint8m1_t vs1, size_t vl) {
  return __riscv_vfqwbdota_f8e5m2_f32_mu(vm, vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                         vl);
}
