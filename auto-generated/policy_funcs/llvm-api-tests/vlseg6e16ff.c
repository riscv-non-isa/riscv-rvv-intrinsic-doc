...
vfloat16mf4x6_t test_vlseg6e16ff_v_f16mf4x6_tum(vbool64_t vm,
                                                ...
                                                const _Float16 *rs1,
                                                size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e16ff_v_f16mf4x6_tum(vm, vd, rs1, new_vl, vl);
}
...
vfloat16mf4x6_t test_vlseg6e16ff_v_f16mf4x6_tumu(vbool64_t vm,
                                                 ...
                                                 const _Float16 *rs1,
                                                 size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e16ff_v_f16mf4x6_tumu(vm, vd, rs1, new_vl, vl);
}
